...
void MENU_Execute(S_ParamGen *pParam) {
    ...
    //début menu 
    switch (s_menu.menu) {
            //Sous menu de séléctions du paramètres (*)    
        case AmplSel:
            if (Pec12IsPlus()) {
                Pec12ClearPlus();
        ...
        case OffsetSel:
            ...
            Pec12SelSave();
            break;
            //Sous menu de séléctions de paramètres (value + assignations)   
        case FormeSet:
            if (Pec12IsPlus()) {
                Pec12ClearPlus();
        ...
        case Save:
            ...
            if (PLIB_PORTS_PinGet(S_OK, PORT_CHANNEL_G, PORTS_BIT_POS_12) == 0) {
                ...
                //test sauvegarde annulée/réuissie + timing 2s 
                if ((Savecnt > _2S) && ((flagS9 == 2) || (flagS9 == 1))) {
    ...
    //Lorsque qu'on est dans le menu supérieur test pour Save mode
    switch (s_menu.menu) {
        case AmplSel:
        case FormeSel:
        case FreqSel:
...
//fonction pour renvois dans les sous menus supérieurs
...
//fonction de mise à jour de l'écrant 
//à voir pour faire 1 fois sur 10 etc 
